...
<head>
    ...
    <title>Administracion EASYPRO - Editar Clientes</title>
    ...
    <div class="grid contenedor contenido-principal">
        ...
        <main class="caja-contenido col-9"> 
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>" method="POST">
                ...
                <div class="enviar">
                <input type="submit" name="enviar" class="btn btn-verde" value="Actualizar cliente"> &nbsp;&nbsp;&nbsp;
                <a href="clientes-mostrar.php" class="btn btn-amarillo"><i class="fa fa-undo"></i>Volver</a>
